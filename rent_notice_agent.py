...
<p style="color:#1a2e44;font-weight:bold;font-size:18px;">&#9654;&nbsp;P VENTURES</p>
<hr style="border:none;border-top:2px solid #1a2e44;margin-bottom:20px;">

<p>Dear {tenant['tenant_name']},</p>

<p>Your rent account remains unpaid as of <strong>{today_str}</strong>. Attached is your
official <strong>3-Day Notice to Pay Rent or Deliver Possession</strong> pursuant to
Florida Statute &sect;&nbsp;83.56.</p>

<table style="border-collapse:collapse;background:#f8f8f8;border-radius:6px;
              padding:12px;margin:16px 0;width:100%;">
  <tr>
    <td style="padding:6px 16px 6px 12px;font-weight:bold;white-space:nowrap;">Past Due Rent:</td>
    <td style="padding:6px 0;">${balance['rent_balance']:,.2f}</td>
  </tr>
  <tr>
    <td style="padding:6px 16px 6px 12px;font-weight:bold;">Late Fees:</td>
    <td style="padding:6px 0;">${balance['late_fee_balance']:,.2f}</td>
  </tr>
  <tr style="border-top:1px solid #ddd;">
    <td style="padding:8px 16px 6px 12px;font-weight:bold;">TOTAL DUE:</td>
    <td style="padding:8px 0;font-weight:bold;">${balance['total_balance']:,.2f}</td>
  </tr>
  <tr>
    <td style="padding:6px 16px 6px 12px;font-weight:bold;">Property:</td>
    <td style="padding:6px 0;">{tenant['full_address']}</td>
  </tr>
  <tr>
    <td style="padding:6px 16px 6px 12px;font-weight:bold;">Notice Date:</td>
    <td style="padding:6px 0;">{today_str}</td>
  </tr>
  <tr>
    <td style="padding:6px 16px 6px 12px;font-weight:bold;color:#c00;">Deadline:</td>
    <td style="padding:6px 0;font-weight:bold;color:#c00;">{deadline}</td>
  </tr>
</table>

<p><strong>You have three (3) business days from today (excluding weekends and legal
holidays) to pay the full amount owed or vacate the premises.</strong> Failure to do so
will result in eviction proceedings and legal action.</p>

<p>All payments must be made electronically via
<a href="https://doorloop.com">Doorloop.com</a> per Section 3 of your Lease Agreement.</p>

<p>If you believe this notice has been sent in error, contact us immediately.</p>

<p>Sincerely,<br>
<strong>{CONFIG['LANDLORD_NAME']}, {CONFIG['LANDLORD_TITLE']}</strong><br>
...
The attached PDF document may be used as evidence in legal proceedings pursuant to
Florida Statute &sect;&nbsp;83.56(3).
</p>
</body></html>"""
    ...
    try:
        with smtplib.SMTP_SSL("smtp.gmail.com", 465) as srv:
            ...
            srv.sendmail(
                ...
                [tenant["tenant_email"], CONFIG["NOTIFY_EMAIL"]],
                msg.as_string(),
            )
